    ...
    <section ref={sectionRef} id="ingredients" className="relative bg-black">
      ...
      <div className="section-container pt-24 pb-16">
        <div className="max-w-4xl">
          <span className="inline-block px-4 py-1.5 bg-purple/20 text-purple-light text-xs font-bold uppercase tracking-wider rounded-full mb-8">
            The Formula
          </span>
          <h2 className="text-[12vw] sm:text-[8vw] lg:text-[6vw] font-black uppercase leading-[0.85] tracking-tight text-white mb-6">
            Powered By
            <br />
            <span className="text-purple">Nature</span>
          </h2>
          <p className="text-xl sm:text-2xl text-white/40 max-w-2xl leading-relaxed">
      ...
      <div className="section-container pb-20">
        {ingredients.map((item, i) => (
          <div
            ...
            className="sticky top-[8vh] mb-6"
          >
            <div
              className="w-full max-w-3xl mx-auto bg-white rounded-2xl overflow-hidden shadow-2xl"
            >
              <div className="flex flex-col justify-between p-6 sm:p-8 lg:p-10">
                {/* Top — Number & Origin */}
                <div className="flex items-start justify-between">
                  <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-purple/60">
                    0{i + 1} / 04
                  </span>
                  <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-purple/60">
                ...
                <div className="py-6 sm:py-8 flex items-center justify-center">
                  <span className="text-[20vw] sm:text-[14vw] lg:text-[120px] font-black leading-none tracking-tighter text-purple/30">
                    {item.percentage}
                  </span>
                </div>
                ...
                <div>
                  <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-black mb-2">
                    {item.name}
                  </h3>
                  <p className="text-black/40 text-base sm:text-lg leading-relaxed max-w-lg">
                    {item.description}
                  </p>
                </div>
              </div>
      ...
      <div className="section-container pb-20">
        <div className="flex flex-wrap items-center justify-center gap-8 lg:gap-14">
          {['Dermatologist Tested', 'Cruelty Free', 'Vegan', 'Sulfate Free', 'Paraben Free'].map((badge) => (
            <span key={badge} className="text-[11px] font-bold uppercase tracking-[0.2em] text-white/20 hover:text-purple/50 transition-colors duration-300">
              {badge}
            </span>
          ))}
        </div>
